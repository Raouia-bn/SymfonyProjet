...
{
    /**
     * @Route("/all", name="rate_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/formation/{id}", name="rateFormation_index", methods={"GET"})
     */
    public function index_cand(RateRepository $rateRepository): Response
    {
        return $this->render('rate/index.html.twig', [
            'rates' => $rateRepository->findAll(),
        ]);
